                ...
                <div class="panel-body">
                    <form role="form">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="gcname" placeholder="请输入商品分类名称">
                        </div>
                        <div class="form-group">
                        ...
                        <button type="button" class="btn btn-success" id="insertBtn"><i class="glyphicon glyphicon-plus"></i> 新增</button>
